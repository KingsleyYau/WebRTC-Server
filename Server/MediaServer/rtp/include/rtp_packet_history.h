...
#ifndef RTP_INCLUDE_PACKET_HISTORY_H_
#define RTP_INCLUDE_PACKET_HISTORY_H_
...
#include <rtp/api/function_view.h>
...
private:
	...
	public:
		...
		uint64_t insert_order() const {
			return insert_order_;
		}
		size_t times_retransmitted() const {
			return times_retransmitted_;
		}
