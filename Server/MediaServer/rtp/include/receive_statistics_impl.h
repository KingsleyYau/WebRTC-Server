...
#ifndef RTP_INCLUDE_RECEIVE_STATISTICS_IMPL_H_
#define RTP_INCLUDE_RECEIVE_STATISTICS_IMPL_H_
...
#include <rtp/include/receive_statistics.h>
...
private:
	bool IsRetransmitOfOldPacket(const RtpPacketReceived& packet,
			int64_t now_ms) const RTC_EXCLUSIVE_LOCKS_REQUIRED(stream_lock_);
...
public:
	...
	void SetMaxReorderingThreshold(uint32_t ssrc, int max_reordering_threshold)
			override;
