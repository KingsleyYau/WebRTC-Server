 ...
 */
#ifndef RTP_MODULES_REMOTE_BITRATE_ESTIMATOR_INTER_ARRIVAL_H_
#define RTP_MODULES_REMOTE_BITRATE_ESTIMATOR_INTER_ARRIVAL_H_
...
private:
	struct TimestampGroup {
		TimestampGroup() :
				size(0), first_timestamp(0), timestamp(0), first_arrival_ms(-1), complete_time_ms(
						-1) {
		}
