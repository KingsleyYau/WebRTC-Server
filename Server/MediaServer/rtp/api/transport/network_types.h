...
#ifndef RTP_API_TRANSPORT_NETWORK_TYPES_H_
#define RTP_API_TRANSPORT_NETWORK_TYPES_H_
#include <stdint.h>
...
struct PacerConfig {
	...
	DataRate data_rate() const {
		return data_window / time_window;
	}
	DataRate pad_rate() const {
		return pad_window / time_window;
	}
};
