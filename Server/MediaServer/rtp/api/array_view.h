...
#ifndef RTP_API_ARRAY_VIEW_H_
#define RTP_API_ARRAY_VIEW_H_
...
public:
	...
	ArrayView(U* data, size_t size) :
		...
		RTC_DCHECK_EQ(size == 0 ? nullptr : data, this->data()); RTC_DCHECK_EQ(size, this->size()); RTC_DCHECK_EQ(!this->data(),
	...
	ArrayView(std::nullptr_t, size_t size) :
		...
		static_assert(Size == 0 || Size == impl::kArrayViewVarSize, ""); RTC_DCHECK_EQ(0, size);
	}
	...
	T& operator[](size_t idx) const {
		RTC_DCHECK_LT(idx, this->size()); RTC_DCHECK(this->data());
